...
<body>
	...
	<section class="container table-responsive">
		<ul  class="list-group list-group-horizontal">
			...
			<c:forEach var="n" items="${paging.navigatepageNums}">
				<c:choose>
					<c:when test="${n eq paging.pageNum}">
						<li class="list-group-item active"><a href="/salgrade/page/${n}/${paging.pageSize}" class="text-warning">${n}</a></li>
					</c:when>
			...
			<li><a href="/salgrade/page/${paging.navigateLastPage+1}/${paging.pageSize}" class="list-group-item">Next</a></li>
		</ul>
